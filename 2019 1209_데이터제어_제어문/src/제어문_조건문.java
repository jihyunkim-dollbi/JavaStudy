...
public class 제어문_조건문 {    // 두개의 클래스. 1. Scanner 2. public class
	...
	public static void main(String[] args) {
		 ...
		 *                 ==========
		 *                 1. System, String, Math class 들.
		 *    2. return  : 모든 메소드는 return을 가지고 있다. 따라서 생략가능 가상머신에서 추가로 해줌. 
		 *    3. 상속  : 모든 클래스(사용자정의- 우리가 직접 만든 것.)는 object 상속 가지고 있다.superclass 로 받음  (라이브러리는 이미 만들어진것.)
		 ...
		 */
		 ...
		 // 키보드입력
		 Scanner scan = new Scanner(System.in);  //키보드 입력값을 저장했다가 출력함
