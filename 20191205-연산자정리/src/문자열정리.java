...
public class 문자열정리 {
	...
	//	System.out.println(s=s.toUpperCase());   // 이렇게 s를  완전히 바꾸지 않는 한  저장해 놓지 않으면 원본은 바뀌지 않음.
		...
		System.out.println(s.trim());    //맨끝과 맨 앞만!네이버는 아이디란에 트림적용 안됨 , 네이트 아이디란에는 트림 적용됨.	오라클은 공백을 허용안한다. 사용자실수로 되지 않도록 트림을 넣어줌
