...
public class 단항연산자 {
	...
	// and  연산자는 앞의 연산이  false이기 때문에 뒤의 연산은 되지 않는다. 
	// or 연산일 경우는 앞에있는게 true면 종로. false면 뒤에 있는것 연산함.
        ...
        // ! => 부정연산자 => boolean  => 조건문을 만들때 주로 사용!   !(--------) 앞에 !를 붙여줌  
	//~ 안되는 것을 구하고 싶을때, 먼저 범위를 주고 ! 를 붙이면 범위에 포함 안되는 것을 구할수있다.
        // 3,5를 구할때 1246789  => !(seat==3||seat==5)  
